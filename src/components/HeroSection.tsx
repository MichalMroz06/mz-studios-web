...
export default function HeroSection() {
  return (
    <Box sx={{ textAlign: 'center', pt: { xs: 4, md: 6 }, pb: { xs: 6, md: 8 }, px: { xs: 2, md: 8 } }}>
      ...
      >
        Niezależne studio game dev specjalizujące się w unikalnych grach PC.
        Łączymy pasję do innowacyjnych mechanik rozgrywki, wciągającą historię z klimatyczną oprawą graficzną w pixel art.
      </Typography>
